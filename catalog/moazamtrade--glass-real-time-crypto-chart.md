...
```tsx
glass-real-time-crypto-chart.tsx
"use client"
...
code.demo.1756500193987.tsx
import RealTimeGlassChart from "@/components/ui/glass-real-time-crypto-chart";

export default function DemoOne() {
  return (
    <div className="min-h-screen flex justify-center item-center h-full py-14">
    <RealTimeGlassChart />
    </div>
  );
}
...
```tsx
src/components/ui/glass-real-time-crypto-chart.tsx
"use client"
