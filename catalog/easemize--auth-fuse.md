...
```tsx
src/components/ui/auth-fuse.tsx
"use client";
...
```bash
clsx, lucide-react, tailwind-merge, @radix-ui/react-slot, @radix-ui/react-label, class-variance-authority
```
