...
code.demo.1760627149134.tsx
import { Footer } from "@/components/ui/vercel-footer";
...
```tsx
src/components/ui/vercel-footer.tsx
"use client";
...
```bash
next, next-themes, @aliimam/icons, @aliimam/logos
```
