...
```bash
clsx, date-fns, lucide-react, tailwind-merge, react-day-picker, @radix-ui/react-slot, @radix-ui/react-label, @radix-ui/react-dialog, @radix-ui/react-select, @radix-ui/react-popover, class-variance-authority
```
