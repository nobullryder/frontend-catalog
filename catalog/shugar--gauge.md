...
export const Demo = () => (
  <div className="flex flex-col gap-16">
    ...
    <div className="flex flex-col gap-8">
      <div className="font-bold text-xl dark:text-white">Show value</div>
      <div className="flex gap-8 items-center justify-center">
...
export const ArcPriority = () => (
  <div className="flex flex-col gap-8">
    <div className="font-bold text-xl dark:text-white">Arc priority</div>
    <div className="flex gap-8 items-center justify-center mt-2">
      <Gauge
        arcPriority="equal"
        value={80}
...
export const CustomSecondaryColor = () => (
  <div className="flex flex-col gap-8">
    <div className="font-bold text-xl dark:text-white">Custom secondary color</div>
    <div className="flex gap-8 items-center justify-center mt-2">
      <Gauge
          value={50}
          colors={{
