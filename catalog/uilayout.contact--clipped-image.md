...
interface ClippedGoeyGalleryProps extends React.ComponentPropsWithoutRef<'section'> {
...
const ClippedGoeyGallery = React.forwardRef<HTMLElement, ClippedGoeyGalleryProps>(
  ({ mediaItems, className, ...props }, ref) => {
    ...
    return (
      <>
        ...
        <section
          ref={ref}
          className={`grid grid-cols-3 gap-8 dark:bg-black bg-white border rounded-lg p-5 ${className || ''}`}
          {...props}
        >
...
```tsx
src/components/ui/clipped-image.tsx
// component.tsx
import React from 'react';
