...
export default function Example() {
    return (
        <div className="bg-white divide-gray-300/60 flex space-x-5 divide-x pl-3 text-sm rounded border border-gray-300/60">
            ...
            <div className="flex flex-col items-center divide-y divide-gray-500/30">
                <button type="button" className="text-indigo-500 font-medium h-full w-28 hover:bg-indigo-500/10 transition-all">Reply</button>
                <button type="button" className="text-gray-500 font-medium h-full w-28 hover:bg-gray-300/10 transition-all">Don't allow</button>
            </div>
        </div>
    );
};
