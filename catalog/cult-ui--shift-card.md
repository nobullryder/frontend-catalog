...
code.demo.1750442554394.tsx
// FILE: src/demos/shift-card-demo.tsx
"use client"

import { motion as framerMotion } from "framer-motion"

import { Component } from "@/components/ui/shift-card"
import { TextureButton } from "@/components/ui/texture-button" // Assuming TextureButton is correctly placed
  ...
  const topContent = (
    <div className="bg-accent/90 rounded-md text-primary shadow-[0px_1px_1px_0px_rgba(0,0,0,0.05),0px_1px_1px_0px_rgba(255,252,240,0.5)_inset,0px_0px_0px_1px_hsla(0,0%,100%,0.1)_inset,0px_0px_1px_0px_rgba(28,27,26,0.5)] dark:shadow-[0_1px_0_0_rgba(255,255,255,0.03)_inset,0_0_0_1px_rgba(255,255,255,0.03)_inset,0_0_0_1px_rgba(0,0,0,0.1),0_2px_2px_0_rgba(0,0,0,0.1),0_4px_4px_0_rgba(0,0,0,0.1),0_8px_8px_0_rgba(0,0,0,0.1)]">
      <h3 className=" text-lg  p-4">
        ...
        >
          <g clipPath="url(#clip0_912_3_demo)">
            <path
  ...
  const topAnimateContent = (
    <>
      <framerMotion.img
        ...
        src="https://i.ibb.co/Tqk431C4/1za.png"
        layoutId="img_demo"
        width={78}
        height={100}
        alt="basic image"
...
export default ShiftCardDemo
```

Copy-paste these files for dependencies:
```tsx
src/components/ui/shift-card.tsx
// FILE: src/components/ui/component.tsx
import * as React from "react"
import { AnimatePresence as FramerAnimatePresence, MotionProps as FramerMotionProps, motion as framerMotion } from "framer-motion"
