...
function HeatmapIncidentReportCard({ title = "Incident Report" }: HeatmapIncidentReportCardProps): JSX.Element {
  return (
...
```tsx
src/components/ui/heat-map-middle.tsx
'use client';
