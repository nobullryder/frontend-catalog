...
import { cn } from '@/lib/utils' // Assuming cn is available for potential future use, though not strictly needed in the current implementation
...
```bash
next, next-themes, lucide-react, framer-motion
```
