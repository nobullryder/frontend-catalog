...
```tsx
circle-animations-collection-3.tsx
"use client";
...
code.demo.1753797457043.tsx
import { CircleAnimationsGrid } from '@/components/ui/circle-animations-collection-3';
...
```tsx
src/components/ui/circle-animations-collection-3.tsx
"use client";
