...
import { DataGrid } from '@/components/ui/data-grid-table';
import { DataGridColumnHeader } from '@/components/ui/data-grid-table';
import { DataGridColumnVisibility } from '@/components/ui/data-grid-table';
...
```tsx
src/components/ui/data-grid-table.tsx
'use client';
...
```bash
@tanstack/react-table, @dnd-kit/core, @dnd-kit/modifiers, @dnd-kit/sortable, @dnd-kit/utilities, class-variance-authority, lucide-react
```
