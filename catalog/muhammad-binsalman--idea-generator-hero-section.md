...
```tsx
idea-generator-hero-section.tsx
...
code.demo.1756467486564.tsx
import { HeroSection } from "@/components/ui/idea-generator-hero-section";
...
```tsx
src/components/ui/idea-generator-hero-section.tsx
import React, { useState } from 'react';
import { Lightbulb } from 'lucide-react';
