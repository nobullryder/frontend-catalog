...
code.demo.1755239867372.tsx
import App from "@/components/ui/crystal-forge-hero";
...
```tsx
src/components/ui/crystal-forge-hero.tsx
"use client";
...
```bash
clsx, three, framer-motion, tailwind-merge
```
