...
export default function BarChartDemo90Days() {
  return (
    <div className="w-full">
      <BarChart data={dailyData} xDataKey="day" barGap={0.1} aspectRatio="4 / 1">
        <Grid horizontal />
...
```bash
@visx/event, @visx/gradient, @visx/grid, @visx/responsive, @visx/scale, motion, react-use-measure, clsx, tailwind-merge
```
