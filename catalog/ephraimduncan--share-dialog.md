...
```bash
clsx, lucide-react, tailwind-merge, @radix-ui/react-slot, @radix-ui/react-label, @radix-ui/react-dialog, @radix-ui/react-switch, @radix-ui/react-tooltip, class-variance-authority
```
