...
export default function Example() {
    return (
        <div className="flex items-center justify-between w-full max-w-80 text-gray-500 font-medium">
            <button type="button" aria-label="prev" className="rounded-full border border-slate-200 hover:bg-slate-100/70 active:scale-95 transition-all">
            ...
            <button type="button" aria-label="next" className="rounded-full border border-slate-200 hover:bg-slate-100/70 active:scale-95 transition-all">
