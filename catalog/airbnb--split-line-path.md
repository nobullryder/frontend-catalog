...
code.demo.1748002058109.tsx
// src/DemoOne.tsx (or your specific demo file name and location)
...
```tsx
src/components/ui/split-line-path.tsx
// src/components/ui/component.tsx
...
```bash
lodash, @visx/curve, @visx/shape, @visx/gradient
```
