...
code.demo.1749644901571.tsx
// demo.tsx
import AutoLayoutCard from '@/components/ui/auto-layout-card';

const AutoLayoutCardDemo = () => {
  return (
    <main
      className="bg-background relative flex min-h-screen w-full items-start justify-center bg-cover bg-center px-4 py-10 md:items-center"
      style={{
        backgroundImage:
...
export { AutoLayoutCardDemo as DemoOne };
```

Copy-paste these files for dependencies:
```tsx
src/components/ui/auto-layout-card.tsx
// component.tsx
'use client';
