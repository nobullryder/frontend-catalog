...
```bash
lucide-react, @radix-ui/react-dropdown-menu, @radix-ui/react-slot, class-variance-authority, @radix-ui/react-dialog, @radix-ui/react-tooltip, @radix-ui/react-separator
```
