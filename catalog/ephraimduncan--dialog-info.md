...
```tsx
src/components/ui/dialog-info.tsx
"use client";
...
```bash
clsx, lucide-react, tailwind-merge, @radix-ui/react-slot, @radix-ui/react-label, @radix-ui/react-avatar, @radix-ui/react-dialog, class-variance-authority
```
