...
export default function WithoutCloseButton() {
	return (
		<Dialog>
			<DialogTrigger asChild>
				<Button variant="outline">No Close Button Dialog</Button>
			</DialogTrigger>
			<DialogContent>
				<DialogHeader hideCloseButton>
					<DialogTitle>No Close Button Dialog</DialogTitle>
					<DialogDescription>
						This dialog does not show the default close button.
					</DialogDescription>
				</DialogHeader>
				<DialogBody>
					<p>This dialog does not show the default close button.</p>
				</DialogBody>
				<DialogFooter>
					<DialogClose asChild>
						<Button variant="outline">Close</Button>
					</DialogClose>
					<Button onClick={() => alert('Do something to close the dialog!')}>
						Do Action
					</Button>
				</DialogFooter>
			</DialogContent>
