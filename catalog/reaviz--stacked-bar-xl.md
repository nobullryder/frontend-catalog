...
code.demo.1748119771533.tsx
import React from 'react';
import ComprehensiveIncidentReportCard from '@/components/ui/stacked-bar-xl';

function ComprehensiveIncidentReportCardDemoPage() {
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100 dark:bg-neutral-900 p-4 transition-colors duration-300">
      <ComprehensiveIncidentReportCard />
    </div>
  );
}

export default ComprehensiveIncidentReportCardDemoPage;
```

Copy-paste these files for dependencies:
```tsx
src/components/ui/stacked-bar-xl.tsx
'use client';
