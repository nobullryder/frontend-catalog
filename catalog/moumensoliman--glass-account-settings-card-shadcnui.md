...
```tsx
glass-account-settings-card-shadcnui.tsx
...
code.demo.1773287998715.tsx
import { GlassAccountSettingsCard } from "@/components/ui/glass-account-settings-card-shadcnui"
...
```tsx
uitripled/glass-account-settings-card-shadcnui.tsx
import { Badge } from "@/components/ui/badge";
import { Button } from "@/components/ui/button";
import { Label } from "@/components/ui/label";
import { Switch } from "@/components/ui/switch";
