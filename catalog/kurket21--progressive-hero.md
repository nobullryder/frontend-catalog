...
```tsx
src/components/ui/progressive-hero.tsx
"use client";
// Button component and utilities inlined for local use
import * as React from "react";
import { Slot } from "@radix-ui/react-slot";
...
```bash
clsx, lucide-react, framer-motion, tailwind-merge, @radix-ui/react-slot, class-variance-authority
```
