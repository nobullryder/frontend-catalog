...
code.demo.1748119704163.tsx
import React from 'react';
import DetailedStackedBarReport from '@/components/ui/stacked-bar-medium'; 

function DetailedStackedBarReportDemoPage() {
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100 dark:bg-gray-800 p-4 transition-colors duration-300">
      ...
      <DetailedStackedBarReport />
    </div>
  );
}

export default DetailedStackedBarReportDemoPage;
```

Copy-paste these files for dependencies:
```tsx
src/components/ui/stacked-bar-medium.tsx
import { useState } from "react";
import { cn } from "@/lib/utils";
