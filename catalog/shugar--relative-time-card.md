...
code.demo.1747771972840.tsx
import React from "react";
import { RelativeTimeCard } from "@/components/ui/relative-time-card.tsx";
import { Button } from "@/components/ui/button";

export const Demo = () => (
    <div className="flex flex-col h-screen w-full items-center gap-2 justify-center">
