...
code.demo.1761994137914.tsx
import {
  CircularGallery,
  type GalleryItem,
} from "@/components/ui/circular-gallery-2"; // Adjust this path to your component location
...
```tsx
src/components/ui/circular-gallery-2.tsx
"use client";
