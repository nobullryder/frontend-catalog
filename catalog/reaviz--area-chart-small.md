...
code.demo.1748117164163.tsx
import React from 'react';
import DetailedStackedIncidentReportCard from '@/components/ui/area-chart-small'; // Adjust path as per your actual structure
...
```tsx
src/components/ui/area-chart-small.tsx
'use client';
