...
code.demo.1747219782476.tsx
import * as React from "react";
import { CommandPalette } from "@/components/ui/command-palette";

// Demo variant: shadcn/ui style Command Palette
function DemoCommandPaletteShadcn() {
  const [open, setOpen] = React.useState(true);
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-center bg-background">
      <CommandPalette open={open} setOpen={setOpen} />
      <div className="mt-8 text-center text-muted-foreground text-base">
        You can open the Command Palette using the icon at the top right or by pressing{" "}
...
export { DemoCommandPaletteShadcn };
