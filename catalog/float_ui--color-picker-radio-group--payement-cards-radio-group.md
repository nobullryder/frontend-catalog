          ...
          return (
            <li key={id}>
              <label htmlFor={id} className="block relative">
                ...
                {/* Checkmark */}
                <div className="absolute top-4 right-4 flex items-center justify-center w-4 h-4 rounded-full border peer-checked:bg-indigo-600 text-white duration-200">
                  <svg
