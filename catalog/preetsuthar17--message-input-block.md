...
code.demo.1760769276002.tsx
import MessageInput from "@/components/ui/message-input-block";

export default function DemoOne() {
  return <div className="max-w-md w-full"><MessageInput/></div>;
}
...
```tsx
src/components/ui/message-input-block.tsx
"use client";
