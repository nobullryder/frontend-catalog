...
code.demo.1751129447765.tsx
import { Alert, AlertIcon, AlertTitle, AlertToolbar } from '@/components/ui/mono-alerts';
import { Button } from '@/components/ui/button';
import {
...
export default function DemoOne() {
  return (
    <div className="flex flex-col items-center w-full max-w-[800px] gap-6">
      <Alert variant="mono" icon="primary" close={true}>
        <AlertIcon>
          <RiNotificationFill className="text-blue-500"/>
        </AlertIcon>
...
```tsx
src/components/ui/mono-alerts.tsx
import * as React from 'react';
import { cn } from '@/lib/utils';
import { Button } from '@/components/ui/button';
import { cva, type VariantProps } from 'class-variance-authority';
