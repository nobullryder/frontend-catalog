...
// Avatar variants demo (brand, neutral, error, success, warning)
...
export default function AvatarVariants() {
  return (
    <>
      <Component variant="brand">B</Component>
      <Component variant="neutral">N</Component>
      <Component variant="error">E</Component>
      <Component variant="success">S</Component>
      <Component variant="warning">W</Component>
    </>
  );
}
