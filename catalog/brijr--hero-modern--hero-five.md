      ...
      <Container className="not-prose">
        ...
        <div className="flex w-full justify-between">
          <div>
            ...
            <h2 className="w-48 text-lg font-light leading-6">Another component from Craft UI.</h2>
          </div>
          <div className="hidden gap-4 md:flex">
            <Link className="transition-all hover:opacity-70" href="#">Book a component</Link>
            <Link className="transition-all hover:opacity-70" href="#">Heros</Link>
            <Link className="transition-all hover:opacity-70" href="#">Shop</Link>
            <Link className="transition-all hover:opacity-70" href="#">Learn More</Link>
          </div>
        </div>
        ...
        <div className="absolute bottom-2 right-2 flex h-12 w-12 items-center justify-center rounded-full border bg-secondary p-12 text-center font-medium leading-4 transition-all hover:opacity-80">
          <Link className="-mt-1" href="#">Get Started</Link>
        </div>
      </Container>
    </Section>
  );
