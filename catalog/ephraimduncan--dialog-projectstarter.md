...
```tsx
src/components/ui/dialog-projectstarter.tsx
"use client";
...
```bash
clsx, lucide-react, tailwind-merge, @radix-ui/react-slot, @radix-ui/react-label, @radix-ui/react-dialog, @radix-ui/react-select, class-variance-authority, @radix-ui/react-separator
```
