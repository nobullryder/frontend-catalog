...
const Logo = 'https://components.work/_next/static/media/logo.f5329ef0.svg'
      ...
      <Container>
        <div className="m-auto flex h-full w-full max-w-5xl flex-col gap-8 px-4 py-4 md:px-6 md:py-10">
          ...
          <div className="flex w-fit flex-wrap items-center gap-6 rounded-lg border p-4">
            ...
            {/* Если Next/Image с SVG не работает в твоём сетапе, замени на <img src={(Logo as unknown as string)} .../> */}
            <Image className="h-6 w-fit dark:invert" src={Logo} alt="Logo 1" />
            <Image className="h-6 w-fit dark:invert" src={Logo} alt="Logo 2" />
            <Image className="h-6 w-fit dark:invert" src={Logo} alt="Logo 3" />
          </div>

          {/* End Text */}
          <div className="md:text-lg">
            <p className="hidden md:block">We make components for marketing sites.</p>

            <div className="grid gap-2 md:flex">
              <p className="opacity-50">Visit craftui.org to use our components for free.</p>
            ...
            <p className="mt-4 text-xs">
              <span className="opacity-50">Available now online.</span> Tell us what you build next.
            </p>
          </div>
        </div>
      </Container>
