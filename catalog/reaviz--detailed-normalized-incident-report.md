...
```tsx
detailed-normalized-incident-report.tsx
'use client';
...
code.demo.1748118016189.tsx
import React from 'react';
import DetailedNormalizedIncidentReport from '@/components/ui/detailed-normalized-incident-report'; // Adjust path as per your actual structure

function DetailedNormalizedIncidentReportDemoPage() {
  return (
...
export default DetailedNormalizedIncidentReportDemoPage;
```

Copy-paste these files for dependencies:
```tsx
src/components/ui/detailed-normalized-incident-report.tsx
'use client';
