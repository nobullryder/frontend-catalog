...
export default function DemoOne() {
  return (
    <div className="flex flex-wrap gap-5">
        ...
        <Button isDisabled color="secondary" size="sm">Button sm</Button>
        <Button isDisabled color="secondary" size="md">Button md</Button>
        <Button isDisabled color="secondary" size="lg">Button lg</Button>
        <Button isDisabled color="secondary" size="xl">Button xl</Button>
    </div>
  );
}
...
```bash
tailwind-merge, react-aria-components
```
