...
export default function Component() {
  return (
    <div className="fixed inset-0 -z-10 bg-neutral-950">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_85%_70%_at_50%_-8%,rgba(99,102,241,0.32),transparent)]" />
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_80%_60%_at_60%_115%,rgba(56,189,248,0.22),transparent)]" />
