...
code.demo.1748116752884.tsx
import React from 'react';
import StackedIncidentReportChart from '@/components/ui/stacked-chart'; 
function StackedIncidentReportChartDemoPage() {
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100 dark:bg-gray-800 p-4 transition-colors duration-300">
      <StackedIncidentReportChart />
    </div>
  );
}

export default StackedIncidentReportChartDemoPage;
```

Copy-paste these files for dependencies:
```tsx
src/components/ui/stacked-chart.tsx
'use client';
