...
code.demo.1748120281258.tsx
import React from 'react';
import DetailedFunnelReportCard from '@/components/ui/funnel-chart-medium';

function DetailedFunnelReportCardDemoPage() {
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100 dark:bg-neutral-900 p-4 transition-colors duration-300">
      <DetailedFunnelReportCard title="Incident Processing Funnel" />
    </div>
  );
}

export default DetailedFunnelReportCardDemoPage;
```

Copy-paste these files for dependencies:
```tsx
src/components/ui/funnel-chart-medium.tsx
'use client';
