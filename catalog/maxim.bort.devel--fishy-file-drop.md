...
export function MyPage() {
  ...
  return (
    <div className="flex flex-col items-center justify-center gap-6">
      ...
      {/* Centered, Tailwind-styled note below main container */}
      <div className="mt-4 text-sm text-gray-500 flex flex-col items-center text-center">
        <span>Only one instance is meant to be used at a time.</span>
        <span className="mt-1">
          Using multiple instances simultaneously<br />
        </span>
        <span className="mt-1">
...
```tsx
src/components/ui/fishy-file-drop.tsx
"use client";
import React, { useState, useRef, useCallback } from "react";
import { motion } from "framer-motion";
