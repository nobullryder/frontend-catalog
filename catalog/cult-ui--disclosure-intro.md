...
// FILE: src/demos/intro-disclosure-demo.tsx
"use client"
...
function IntroDisclosureDemo() {
  ...
  const handleClearDesktop = () => {
    ...
    updateStorageState()
    toast.success("Desktop storage cleared. Refresh page if needed.")
  }
...
export default IntroDisclosureDemo
```
