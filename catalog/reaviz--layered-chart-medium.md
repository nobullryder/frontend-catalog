...
// Color scheme for layered funnel
const layeredFunnelChartColors = ['#EE409430', '#EE409475', '#EE4094', '#BB015A', '#8A0042', '#680031'];
...
interface LayeredFunnelReportCardProps {
  title?: string;
}

function LayeredFunnelReportCard({ title = "Incident Report" }: LayeredFunnelReportCardProps): JSX.Element {
  return (
              ...
              arc={
                <FunnelArc
                  ...
                  glow={{
                    ...
                    color: 'rgba(238, 64, 148, 0.6)', // Glow color with opacity, base #EE4094
                  }}
                />
              }
              axis={
...
export default LayeredFunnelReportCard;

code.demo.1748120691058.tsx
import React from 'react';
import LayeredFunnelReportCard from '@/components/ui/layered-chart-medium';

function LayeredFunnelReportCardDemoPage() {
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100 dark:bg-neutral-900 p-4 transition-colors duration-300">
      <LayeredFunnelReportCard title="Detailed Incident Funnel" />
    </div>
  );
}

export default LayeredFunnelReportCardDemoPage;
```

Copy-paste these files for dependencies:
```tsx
src/components/ui/layered-chart-medium.tsx
'use client';
