...
export default function BlocksSec() {
        ...
        <div className="w-full ">
          <section className="xl:mr-0 mr-3 mt-16 w-full">
            <TimelineContent
              ...
              className="flex md:flex-row flex-col gap-4 w-full justify-between mb-4 mt-0 rounded-lg dark:from-black/40 to-blue-100 to-100% from-zinc-100 border backdrop-blur-md p-6 2xl:w-[90%] mx-auto relative"
            >
              ...
              <div className="space-y-2 rounded-md dark:text-white text-black">
                ...
                <h1
                  className={cn(
                    "my-1 flex scroll-m-20 not-prose items-center lg:text-3xl text-2xl gap-2 font-medium tracking-tight"
                  )}
                >
              ...
              <div className="text-right md:max-w-lg w-full z-20 space-y-2">
