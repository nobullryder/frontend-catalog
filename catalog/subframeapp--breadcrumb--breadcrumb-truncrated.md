...
export default function BreadcrumbsTruncated() {
  return (
    <div className="max-w-sm">
      <Component>
        <Component.Item>Dashboard</Component.Item>
        <Component.Divider />
        <Component.Item>Analytics</Component.Item>
        <Component.Divider />
        <Component.Item>
          Quarterly performance and engagement breakdown report
        </Component.Item>
        <Component.Divider />
        <Component.Item active>Q2 2025</Component.Item>
      </Component>
    </div>
  );
}
