...
```tsx
interpolation-chart-middle.tsx
'use client';
...
code.demo.1748121104766.tsx
import React from 'react';
import InterpolatedFunnelReportCard from '@/components/ui/interpolation-chart-middle';

function InterpolatedFunnelReportCardDemoPage() {
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100 dark:bg-neutral-900 p-4 transition-colors duration-300">
      <InterpolatedFunnelReportCard title="Step Funnel Report" />
    </div>
  );
}

export default InterpolatedFunnelReportCardDemoPage;
```

Copy-paste these files for dependencies:
```tsx
src/components/ui/interpolation-chart-middle.tsx
'use client';
