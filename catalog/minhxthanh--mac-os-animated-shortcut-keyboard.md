...
```tsx
mac-os-animated-shortcut-keyboard.tsx
...
code.demo.1750850277337.tsx
import MacOSKeyboard from "@/components/ui/mac-os-animated-shortcut-keyboard";
...
```tsx
src/components/ui/mac-os-animated-shortcut-keyboard.tsx
import React, { useState, useEffect } from 'react';
