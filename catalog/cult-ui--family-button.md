...
code.demo.1750441535472.tsx
// FILE: src/demos/family-button-demo.tsx
"use client"
...
import { Component } from "@/components/ui/family-button"
            ...
            >
              ...
              <path
                ...
                style={{
                  fillRule: "evenodd",
                  clipRule: "evenodd",
                  fill: "url(#family-demo-gradient-a)",
                }}
              />
              <path
...
function FamilyButtonDemo() {
  return (
    <div className="w-full h-screen bg-gray-200">
      <Component className="absolute bottom-6 right-6">
        <MusicPlayerExample />
      </Component>
    </div>
  )
...
```tsx
src/components/ui/family-button.tsx
// FILE: src/components/ui/component.tsx
import React, { useState } from "react";
import { motion, AnimatePresence } from "framer-motion";
import { Plus, X } from 'lucide-react';
