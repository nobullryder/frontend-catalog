...
code.demo.1754583468463.tsx
import { AnimatedGeometricCard, CardBody, CardTitle, CardDescription, CardVisual, GeometricVisual } from "@/components/ui/animated-geometric-card";
...
```tsx
src/components/ui/animated-geometric-card.tsx
"use client";
import * as React from "react";
import { useState, useEffect } from "react";
import { type ClassValue, clsx } from "clsx";
