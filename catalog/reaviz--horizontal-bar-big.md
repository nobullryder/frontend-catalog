...
code.demo.1748119214167.tsx
import React from 'react';
import DetailedIncidentReportCard from '@/components/ui/horizontal-bar-big';

function DetailedIncidentReportCardDemoPage() {
  return (
...
export default DetailedIncidentReportCardDemoPage;
```

Copy-paste these files for dependencies:
```tsx
src/components/ui/horizontal-bar-big.tsx
'use client';
