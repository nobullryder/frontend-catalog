...
export default function PriorityPyramidDemoPage() {
  return (
    <div className="p-10">
      <h1 className="text-2xl font-semibold mb-6">Priority Pyramid Calendar</h1>
...
```tsx
src/components/ui/priority-pyramid-calendar.tsx
"use client"
