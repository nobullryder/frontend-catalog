...
```tsx
src/components/ui/dialog-deactivate.tsx
...
```bash
clsx, lucide-react, tailwind-merge, @radix-ui/react-slot, @radix-ui/react-dialog, class-variance-authority
```
