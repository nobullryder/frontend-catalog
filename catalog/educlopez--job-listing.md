      ...
      <AnimatePresence>
        {activeItem ? (
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="bg-smooth-1000/10 pointer-events-none absolute inset-0 z-10 bg-blend-luminosity backdrop-blur-xl"
          />
        ) : null}
      </AnimatePresence>
        ...
        {activeItem ? (
          <div className="group absolute inset-0 z-10 grid place-items-center">
            ...
            >
                ...
                <div className="flex grow items-center justify-between">
                  <div className="flex w-full flex-col gap-0.5">
                    ...
                    <motion.p
                      ...
                      className="text-primary-foreground text-sm dark:text-gray-200"
                    >
                      {activeItem.title} / {activeItem.salary}
                    </motion.p>

                    <motion.div
                      className="text-primary-foreground flex flex-row gap-2 text-xs dark:text-gray-300"
              ...
              {/* 🔥 Описание теперь светлое в тёмной теме */}
              <motion.p
                layout
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
          ...
          {jobs.map((role) => (
            ...
            >
              ...
              <div className="flex w-full flex-col items-start justify-between gap-0.5">
                ...
                <motion.div
                  className="text-primary-foreground text-xs dark:text-gray-200"
...
import JobListingComponent, {
  ...
  Supabase,
  Turso,
} from "@/components/ui/job-listing"
...
```tsx
src/components/ui/job-listing.tsx
"use client"
