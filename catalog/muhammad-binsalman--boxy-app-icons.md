...
const AppIcons = () => {
  return (
    ...
    >
      ...
      {/* Icon 1 - PayPal */}
      <g clipPath="url(#clip0_67_353)" className="group transition-transform duration-300 ease-in-out hover:-translate-y-5 hover:cursor-pointer">
        <g>
          <rect
            fill="#3F454E"
          ...
          <path
            fill="#414750"
            className="group-hover:fill-[#009cde]"
          ...
          <rect
            ...
            height="25.5"
            x="0.433013"
            className="group-hover:stroke-[#009cde]"
          />
          <g clipPath="url(#clip1_67_353)">
            <path
              fill="#6B727C"
              className="group-hover:fill-[#009cde]"
      ...
      {/* Icon 2 - GitLab */}
      <g clipPath="url(#clip2_67_353)" className="group transition-transform duration-300 ease-in-out hover:-translate-y-5 hover:cursor-pointer">
        <g>
          <rect
            fill="#3F454E"
          ...
          <path
            fill="#414750"
            className="group-hover:fill-[url(#gitlab_gradient)]"
          ...
          <rect
            ...
            height="25.5"
            x="0.433013"
            className="group-hover:stroke-[url(#gitlab_gradient)]"
          />
          <g clipPath="url(#clip3_67_353)">
            <path
              fill="#6B727C"
              className="group-hover:fill-[url(#gitlab_gradient)]"
      ...
      {/* Icon 3 - Instagram */}
      <g clipPath="url(#clip4_67_353)" className="group transition-transform duration-300 ease-in-out hover:-translate-y-5 hover:cursor-pointer">
        <g>
          <rect
            fill="#3F454E"
          ...
          <path
            fill="#414750"
            className="group-hover:fill-[url(#instagram_gradient)]"
          ...
          <rect
            ...
            height="25.5"
            x="0.433013"
            className="group-hover:stroke-[url(#instagram_gradient)]"
          />
          <g clipPath="url(#clip5_67_353)">
            <path
              fill="#6B727C"
              className="group-hover:fill-[url(#instagram_gradient)]"
      ...
      {/* Icon 4 - Telegram */}
      <g clipPath="url(#clip6_67_353)" className="group transition-transform duration-300 ease-in-out hover:-translate-y-5 hover:cursor-pointer">
        <g>
          <rect
            fill="#3F454E"
          ...
          <path
            fill="#414750"
            className="group-hover:fill-[#26a5e4]"
          ...
          <rect
            ...
            height="25.5"
            x="0.433013"
            className="group-hover:stroke-[#26a5e4]"
          />
          <g clipPath="url(#clip7_67_353)">
            <path
              fill="#6B727C"
              className="group-hover:fill-[#26a5e4]"
      ...
      {/* Icon 5 - Spotify */}
      <g clipPath="url(#clip8_67_353)" className="group transition-transform duration-300 ease-in-out hover:-translate-y-5 hover:cursor-pointer">
        <g>
          <rect
            fill="#3F454E"
          ...
          <path
            fill="#414750"
            className="group-hover:fill-[#1db954]"
          ...
          <rect
            ...
            height="25.5"
            x="0.433013"
            className="group-hover:stroke-[#1db954]"
          />
          <g clipPath="url(#clip9_67_353)">
            <path
              fill="#6B727C"
              className="group-hover:fill-[#1db954]"
      ...
      {/* Icon 6 - Discord */}
      <g clipPath="url(#clip10_67_353)" className="group transition-transform duration-300 ease-in-out hover:-translate-y-5 hover:cursor-pointer">
        <g>
          <rect
            fill="#40464F"
          ...
          <rect
            ...
            height="25.5"
            x="0.433013"
            className="group-hover:stroke-[#5865f2]"
          />
          <g clipPath="url(#clip11_67_353)">
            <path
              fill="#6B727C"
              className="group-hover:fill-[#5865f2]"
...
```tsx
src/components/ui/boxy-app-icons.tsx
import React from 'react';
