...
// Avatar sizes demo (x-small → x-large)
...
export default function AvatarSizes() {
  return (
    <>
      <Component size="x-small">AB</Component>
      <Component size="small">AB</Component>
      <Component size="medium">AB</Component>
      <Component size="large">AB</Component>
      <Component size="x-large">AB</Component>
    </>
  );
}
