  ...
  return (
    <div className="flex min-h-screen w-full items-center justify-center bg-background p-8">
      <div className="w-full max-w-xl">
        <Autocomplete items={allItems} getOptionLabel={(o) => (o as any).label}>
          <AutocompleteInput
          ...
          <AutocompletePopup>
            <AutocompleteList>
              {Object.entries(groupedItems).map(([group, items]) => (
                <AutocompleteGroup key={group} items={items}>
...
```tsx
/components/ui/coss-autocomplete.tsx
"use client";
