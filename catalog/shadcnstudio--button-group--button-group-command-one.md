...
const ButtonGroupGhostDemo = () => {
  return (
    <div className='inline-flex w-fit rounded-md rtl:space-x-reverse'>
      <Button variant='ghost' className='btn rounded-none rounded-l-md shadow-none focus-visible:z-10'>
        <SettingsIcon className="icon"/>
        Settings
      </Button>
      <Button variant='ghost' className='btn rounded-none shadow-none focus-visible:z-10'>
        <BoxIcon className="icon"/>
        Dashboard
      </Button>
      <Button variant='ghost' className='btn rounded-none rounded-r-md shadow-none focus-visible:z-10'>
        <ChartBarBigIcon className="icon"/>
        Analytics
      </Button>
    </div>
  )
