...
function LTR_DARK() {
  ...
  return (
    <div className="min-h-screen min-w-[250vh] bg-zinc-900 flex justify-center items-center overflow-x-hidden scrollbar-hide p-8 box-border">
      <div>
        {/* English Buttons */}
...
function RTL_LIGHT() {
  ...
  return (
    <div className="min-h-screen min-w-[250vh] bg-zinc-100 flex justify-center items-center overflow-x-hidden scrollbar-hide p-8 box-border">
      <div>
        {/* Hebrew Buttons */}
        <div className="flex flex-col items-center mb-4">
          <button
...
export { LTR_DARK, RTL_LIGHT };

```

Copy-paste these files for dependencies:
```tsx
src/components/ui/splashed-push-notifications.tsx
import React, { useImperativeHandle, forwardRef, useRef, useEffect } from 'react';
