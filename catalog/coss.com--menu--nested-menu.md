...
import { UserIcon, PaletteIcon, MonitorIcon, SunIcon, MoonIcon, SettingsIcon } from "lucide-react";
import { Button } from "@/components/ui/button";
import { Menu, MenuPopup, MenuItem, MenuSeparator, MenuSub, MenuSubTrigger, MenuSubPopup, MenuTrigger } from "@/components/ui/component";
export default function MenuNestedMenuDemo() {
  return (
    <div className="flex min-h-screen w-full items-center justify-center bg-black p-8">
      <Menu>
        ...
        <MenuPopup>
          ...
          <MenuSub>
            <MenuSubTrigger><PaletteIcon />Theme</MenuSubTrigger>
            <MenuSubPopup>
              <MenuItem><SunIcon />Light</MenuItem>
              <MenuItem><MoonIcon />Dark</MenuItem>
              <MenuItem><MonitorIcon />System</MenuItem>
            </MenuSubPopup>
          </MenuSub>
          <MenuSeparator />
