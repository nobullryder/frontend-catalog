...
```tsx
src/components/ui/living-fluid-hero.tsx
"use client";
...
```bash
three, framer-motion, @react-three/drei, @react-three/fiber, @react-three/postprocessing
```
