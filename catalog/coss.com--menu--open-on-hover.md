...
import { Menu, MenuPopup, MenuSeparator, MenuItem, MenuTrigger } from "@/components/ui/component";
export default function MenuOpenOnHoverDemo() {
  return (
    <div className="flex min-h-screen w-full items-center justify-center bg-black p-8">
      <Menu openOnHover delay={0}>
        <MenuTrigger render={<Button variant="outline">Hover me <ChevronDownIcon /></Button>} />
        <MenuPopup>
