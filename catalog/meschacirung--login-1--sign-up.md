            ...
            >
                <div className="p-8">
                    ...
                    <div>
                        ...
                        <h1 className="mt-6 text-pretty text-2xl font-semibold leading-snug">
                            <span className="block text-muted-foreground">Welcome to Tailark!</span>
                    ...
                    <div className="mt-8 space-y-3">
                        ...
                        >
                            <span className="flex items-center justify-center size-5">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 262" className="w-full h-full">
