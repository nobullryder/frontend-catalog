...
```tsx
noise-dark-blue-gradient-with-squares.tsx
"use client";
...
code.demo.1756799900781.tsx
import Component from "@/components/ui/noise-dark-blue-gradient-with-squares";
...
```tsx
src/components/ui/noise-dark-blue-gradient-with-squares.tsx
"use client";
