...
code.demo.1756569312328.tsx
import { LeaderboardCard } from '@/components/ui/first-place-leaderboard';

export default function LbFirst() {
  return (
...
```tsx
src/components/ui/first-place-leaderboard.tsx
'use client';
