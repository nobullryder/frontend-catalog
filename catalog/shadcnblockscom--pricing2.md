...
```tsx
/components/blocks/pricing2.tsx
"use client";
...
```bash
lucide-react, @radix-ui/react-slot, class-variance-authority, @radix-ui/react-switch, @radix-ui/react-separator, @radix-ui/react-label
```
