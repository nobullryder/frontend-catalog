...
const RAW_FUNNEL_DATA: FunnelDataPoint[] = [
  ...
  { key: 'Invalid Stage', data: "not a number" as any }, // Intentionally invalid
];
...
const IncidentFunnelReportCard: React.FC = () => {
    ...
    <div className="flex flex-col justify-between pt-4 pb-4 bg-white dark:bg-black rounded-3xl shadow-[11px_21px_3px_rgba(0,0,0,0.06),14px_27px_7px_rgba(0,0,0,0.10),19px_38px_14px_rgba(0,0,0,0.13),27px_54px_27px_rgba(0,0,0,0.16),39px_78px_50px_rgba(0,0,0,0.20),55px_110px_86px_rgba(0,0,0,0.26)] w-[600px] h-[714px] overflow-hidden text-black dark:text-white transition-colors duration-300">
      <div className="flex justify-between items-center p-7 pt-6 pb-8">
        ...
        <select
          ...
          className="p-3 pt-2 pb-2 rounded-md bg-gray-100 text-gray-800 dark:bg-[#262631] dark:text-white transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-pink-500"
        >
        ...
        <div className="flex flex-col gap-2 w-1/2">
          ...
          <div className="flex items-center gap-2">
            <CountUp
              ...
              duration={2.5}
            />
            <div className="flex bg-red-500/30 dark:bg-[rgb(232,64,69)]/40 p-1 pl-2 pr-2 items-center rounded-full text-red-700 dark:text-[#F08083] transition-colors duration-300">
        ...
        <div className="flex flex-col gap-2 w-1/2">
          ...
          <div className="flex items-center gap-2">
            <CountUp
              ...
              duration={2.5}
            />
            <div className="flex bg-teal-500/30 dark:bg-[rgb(64,229,209)]/40 p-1 pl-2 pr-2 items-center rounded-full text-teal-700 dark:text-[#40E5D1] transition-colors duration-300">
      ...
      <div className="flex flex-col pl-8 pr-8 font-mono divide-y divide-gray-200 dark:divide-[#262631] transition-colors duration-300">
        {metricItems.map((item, index) => (
          ...
          >
            <div className="flex flex-row gap-2 items-center text-base w-1/2 text-gray-600 dark:text-[#9A9AAF] transition-colors duration-300">
              {React.cloneElement(item.icon, { fill: item.changeType === 'increase' && index < 2 ? 'rgb(232,64,69)' : 'rgb(64,229,209)' })} {/* Dynamic icon fill based on type for first two metrics */}
              ...
              <div
                className={`flex p-1 pl-2 pr-2 items-center rounded-full ${
                  item.changeType === 'increase'
                    ? 'bg-red-500/30 dark:bg-[rgb(232,64,69)]/40 text-red-700 dark:text-[#F08083]'
                    : 'bg-teal-500/30 dark:bg-[rgb(64,229,209)]/40 text-teal-700 dark:text-[#40E5D1]'
...
```tsx
src/components/ui/layered-chart-xl.tsx
'use client';
