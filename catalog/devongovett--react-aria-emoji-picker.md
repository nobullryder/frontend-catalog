...
code.demo.1755276438733.tsx
import EmojiPicker from "@/components/ui/react-aria-emoji-picker";
...
```tsx
src/components/ui/react-aria-emoji-picker.tsx
'use client';
...
```bash
react-aria-components, lucide-react, emojibase
```
