                    ...
                    <div className="main-content">
                        ...
                        <div className="main-info">
                            ...
                            <div className="songs">
                                ...
                                <div className="song"><p className="bold">Blackbiird</p><p className="light">2:11</p></div>
                                <div className="song"><p className="bold">16 Carriages</p><p className="light">3:47</p></div>
                                <div className="song"><p className="bold">Protector</p><p className="light">3:04</p></div>
                                <div className="song"><p className="bold">My Rose</p><p className="light">0:53</p></div>
                                <div className="song"><p className="bold">Smoke Hour ★ Willie Nelson</p><p className="light">0:50</p></div>
                                <div className="song"><p className="bold">Texas Hold 'Em</p><p className="light">3:53</p></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className={`modal ${isArtistModalActive ? 'active' : ''}`} style={{display: isSongModalActive ? 'none' : 'flex'}}>
                        ...
                        <div className="modal-content">
                            <div className="photo-wrapper">
                                ...
                                <img className="photo" style={{filter: 'brightness(1.5) saturate(1) blur(48px)', zIndex: 'auto'}} src="https://www.billboard.com/wp-content/uploads/2022/08/22-beyonce-cr-mason-poole-2022-billboard-1548.jpg?w=942&h=623&crop=1" alt=""/>
                            </div>
                            <div className="info">
                                <div className="info-top">
                                    <div className="info-top-left">
                                        <p className="genre light">Pop</p>
                                        <div className="divider"></div>
...
```tsx
src/components/ui/progressive-blur-modal.tsx
"use client";
