...
code.demo.1760876191786.tsx
import { RippleCanvas } from "@/components/ui/ripple-canvas";

export default function DemoOne() {
  return (
    <main className="w-full h-screen flex items-center flex-col justify-center overflow-hidden">
      <RippleCanvas />
      <h1 className="text-5xl absolute font-bold">
      Ripple Canvas
      </h1>
    </main>
  )
...
```tsx
src/components/ui/ripple-canvas.tsx
"use client"
